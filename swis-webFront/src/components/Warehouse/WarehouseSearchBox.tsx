...
export const WarehouseSearchBox = ({ warehouse }: Props) => {
  ...
  return (
    ...
    >
      ...
      <Text mt={2}>
        ...
        <b>Capacity:</b> {warehouse.capacity}
      </Text>
      <Text mt={2}>
        <Icon as={FaUser} mr={1} /> <b>Keeper:</b> {warehouse.user_id}
      </Text>
      <Text mt={2}>
      ...
      <Text mt={2}>
        <Icon as={FaCity} mr={1} /> <b>Branch:</b> {warehouse.branch_id}
      </Text>
