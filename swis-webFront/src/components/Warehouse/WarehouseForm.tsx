...
// import { Button, FormControl, FormLabel, Input, InputGroup, InputLeftElement, Text } from "@chakra-ui/react";
...
//     const Edit = useEdit<Warehouse,Warehouse2>(ID , "branches");
//     const Create = useCreate<Warehouse, Warehouse2>("branches");
//     const branch = useGetOne<Warehouse>(ID, "branches");
//     const handleEditBranch = (values: Warehouse2) => {
//       if (values.phone)
//         Edit.mutate({
//           name: values.name,
//           phone: values.phone,
...
//         });
//     };
//     const handleAddBranch = (values: Warehouse2) => {
