...
import { BsType } from "react-icons/bs";
  ...
  export const UserSearchCard = ({ user , type }: Props) => {
          ...
          <CardBody>
            ...
            <Heading fontSize="md">
              <VStack m={1}>
                <HStack>
                  <Icon as={FaUser} mr={1} />
                  <Text color={"gray.600"}> {user.name?.en}</Text>
                </HStack>
                <HStack>
                  <Icon as={FaCode} mr={1} />
                ...
                <HStack>
                  <Icon as={BsType} mr={1} />
                  <Text color={"gray.600"}> {user.type === 2 ? "Keeper" : "Donor"}</Text>
                </HStack>
              </VStack>
            </Heading>
